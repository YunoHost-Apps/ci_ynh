...
from ci_ynh import huey_instance
...
LOG_FILE = __Path('__LOG_FILE__')  # /var/log/$app/ci_ynh.log
...
ROOT_URLCONF = 'urls'  # /opt/yunohost/ci_ynh/ynh_urls.py
...
INSTALLED_APPS = [
    ...
    'django_ynh',  # https://github.com/YunoHost-Apps/django_ynh
    'axes',  # https://github.com/jazzband/django-axes
    'bx_py_utils',  # https://github.com/boxine/bx_py_utils
    'huey.contrib.djhuey',  # https://github.com/coleifer/huey
    'huey_monitor',  # https://github.com/boxine/django-huey-monitor
    'ci_ynh',
]

# -----------------------------------------------------------------------------

HUEY = huey_instance.HUEY
...
CACHES = {
    'default': {
        ...
        # If redis is running on same host as ci_ynh, you might
...
LOGGING = {
    ...
    'loggers': {
        ...
        'ci_ynh': {'handlers': ['log_file', 'mail_admins'], 'level': 'INFO', 'propagate': False},
    },
}
